  ...
  <div class="user-wrapper">
      <div class="user-con">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px" label-position="left" class="demo-ruleForm">
          ...
          <el-form-item>
            <el-row :gutter="0">
              <el-col :span="12"><el-button type="primary" size="large" @click="submitForm('ruleForm')">登录</el-button></el-col>
              <el-col :span="12"><el-button size="large" @click="cancelLogin">取消</el-button></el-col>
            </el-row>
          </el-form-item>
          <div class="link-item">
